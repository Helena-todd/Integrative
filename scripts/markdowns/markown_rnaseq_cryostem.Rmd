...
```{r}
colData<-read.xlsx("~/Documents/VIB/Projects/Integrative_Paris/National_cohort/Data synthesis national cohort Cryostem 5042019.xlsx")
...
```{r, eval = FALSE}
save(model_stats, file = "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/recip_only/model_stats.RData")
```

Load the results of modeling for feature selection:
```{r}
load("~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/recip_only/model_stats.RData")
```
...
```{r}
genes_of_interest <- colnames(norm_data)[which(global_aucs >= 0.68)+1]
genes_of_interest
```

I isolate only the top 100 genes (for later comparison with donors and donors - recipients)
```{r}
goi_recip_100 <- colnames(norm_data)[which(global_aucs >= 0.689)+1]
goi_recip_100
```
...
recip_AUCs <- as.data.frame(goi_recip_100) %>% 
  mutate(auc = unlist(global_aucs[which(global_aucs >= 0.689)]))
  
save(recip_AUCs, file = "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/compar/recip_AUCs.RData")
```
...
abline(h= 0.77, col = "red")
```

```{r}
non_prim_genes <- colnames(norm_data)[which(non_prim_aucs >= 0.77)+1]
non_prim_genes
```
...
```{r}
recip_path <- "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/plots/rnaseq_national/recip/"
...
```{r}
non_sec_genes <- colnames(norm_data)[which(non_sec_aucs >= 0.8)+1]
non_sec_genes
```
...
Save the results (it takes a while to run):
```{r, eval = FALSE}
save(model_stats, file = "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/donors_only/model_stats.RData")
```

Load the results of modeling for feature selection:
```{r}
load("~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/donors_only/model_stats.RData")
```
...
```{r}
goi_donor_100 <- colnames(norm_data)[which(global_aucs >= 0.66)+1]
goi_donor_100
```
...
save(donor_AUCs, file = "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/compar/donor_AUCs.RData")
```
...
```{r}
non_prim_genes <- colnames(norm_data)[which(non_prim_aucs >= 0.73)+1]
non_prim_genes
```
...
```{r}
donor_path <- "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/plots/rnaseq_national/donors/"
...
```{r}
non_sec_genes <- colnames(norm_data)[which(non_sec_aucs >= 0.73)+1]
non_sec_genes
```
...
```{r}
prim_sec_genes <- colnames(norm_data)[which(prim_sec_aucs >= 0.73)+1]
prim_sec_genes
```
...
Save the results (it takes a while to run):
```{r, eval = FALSE}
save(model_stats, file = "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/donors_and_recip/model_stats.RData")
```

Load the results of modeling for feature selection:
```{r}
load("~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/donors_and_recip/model_stats.RData")
```
...
global_aucs <- purrr::map(model_stats, 2)
barplot(unlist(global_aucs))
abline(h= 0.689, col = "red")
```

```{r}
goi_dr_100 <- colnames(norm_data)[which(global_aucs >= 0.689)+1]
goi_dr_100
```
...
save(dr_AUCs, file = "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/compar/dr_AUCs.RData")
```
...
the genes that are more expressed in the primary tolerant patients in green, and the ones that are more expressed in the non tolerant patients in red:
```{r}
dr_path <- "~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/plots/rnaseq_national/d-r/"
...
```{r}
non_sec_genes <- colnames(norm_data)[which(non_sec_aucs >= 0.78)+1]
non_sec_genes
```
...
```{r}
prim_sec_genes <- colnames(norm_data)[which(prim_sec_aucs >= 0.78)+1]
prim_sec_genes
```
...
```{r}
load("~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/compar/donor_AUCs.RData")
load("~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/compar/recip_AUCs.RData")
load("~/Documents/VIB/Projects/Integrative_Paris/Integrative/outputs/data/RNA_seq_national/compar/dr_AUCs.RData")
